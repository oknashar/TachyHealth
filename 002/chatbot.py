...
Q_answers={
    ...
    'greetings':'hi there',
    'information':' my name is chatty and you can contact with me on oknashar@gmail.com',
    ...
    'Application': """See also: Virtual assistant
    ...
    'Toys':"""Chatbots have also been incorporated into devices not primarily meant for computing such as toys.
                ...
                """,
    'Chatbot creation':"""The process of creating a chatbot follows a pattern similar to the development of a web page or a mobile app. It can be divided into Design, Building, Analytics and Maintenance.
                            """,
    ...
    'APIs':"""There are many APIs available for building your own chatbots, such as AARC.""",
    
    "Malicious use":"""Malicious chatbots are frequently used to fill chat rooms with spam and advertisements, by mimicking human behaviour and conversations or to entice people into revealing personal information, such as bank account numbers. They are commonly found on Yahoo! Messenger, Windows Live Messenger, AOL Instant Messenger and other instant messaging protocols. There has also been a published report of a chatbot used in a fake personal ad on a dating service's website.""",
}
...
while x!='q' :
    ...
    if x =='q':
        break
    print('BOT',answers[res.index(max(res))])